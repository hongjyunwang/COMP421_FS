...
#
TEST = testprog cache_test chdir_test mkdir_rmdir_test create_test write_test read_test open_test seek_test lookup_test mkyfs_test link_test unlink_test symlink_readlink_test test1 test2 test3
